...
# # Pastikan data transaksi baru memiliki bentuk yang sama dengan data pelatihan (misalnya, jumlah fitur yang sama)
# # Jika perlu, gunakan scaler yang sama dengan yang digunakan pada data pelatihan
